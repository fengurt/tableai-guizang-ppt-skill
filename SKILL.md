...
### 风格 C · Atelier 深空金（Altruistic · Authentic · Artistic · Elegant）

- **White + Deep Blue `#0A1626` + Gold `#A88B52`** — 极简、有灵感感
- **Cormorant Garamond + Outfit + Noto Sans SC** · 与 open-slide Atelier / html-lab 品牌一致
- 适合：两天培训工坊、600 页互动旅程、餐饮/商业实战闭门课
- 模板：`assets/template-atelier.html` · 主题色：`references/themes-atelier.md` · 布局/组件同风格 A
- 美学锚点：深空蓝底上的金色强调，克制而有力
